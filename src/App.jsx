...
export default function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Network Error. Secure server unreachable.");
    } finally {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col selection:bg-cyan-500/30 font-sans overflow-x-hidden">
      ...
      <main className="px-6 pt-12 pb-24 max-w-4xl mx-auto w-full">
        ...
        {!isSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-9">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-9">
                <div className="flex flex-col gap-3">
                  <label className="text-[10px] uppercase font-black tracking-widest text-white/90 ml-1 text-white">Full Identity</label>
                  <input type="text" name="name" placeholder="Agent or Name" required className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 outline-none focus:border-cyan-500 transition-all placeholder:text-white/10 text-white" />
                </div>

                <div className="flex flex-col gap-3">
                  <label className="text-[10px] uppercase font-black tracking-widest text-white/90 ml-1 text-white">Return Email</label>
                  <input type="email" name="email" placeholder="Required" required className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 outline-none focus:border-cyan-500 transition-all placeholder:text-white/10 text-white" />
                </div>
              </div>

              <div className="flex flex-col gap-3">
                <label className="text-[10px] uppercase font-black tracking-widest text-white/90 ml-1 text-white">WhatsApp / Telegram</label>
                <input type="text" name="social" placeholder="@username or phone" required className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 outline-none focus:border-cyan-500 transition-all placeholder:text-white/10 text-white" />
              </div>

              <div className="flex flex-col gap-3">
                <label className="text-[10px] uppercase font-black tracking-widest text-white/90 ml-1 text-white">Visual Evidence</label>
              ...
              <div className="flex flex-col gap-3">
                <label className="text-[10px] uppercase font-black tracking-widest text-white/90 ml-1 text-white">Report Narrative</label>
                <textarea name="message" rows="5" placeholder="Details..." required className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 outline-none focus:border-cyan-500 transition-all placeholder:text-white/10 text-white resize-none"></textarea>
              </div>
          ...
          <div className="min-h-[60vh] flex flex-col items-center justify-center text-center animate-in zoom-in-95 fade-in duration-1000">
            ...
            <h2 className="text-[15vw] font-black italic uppercase tracking-tighter leading-none mb-6 text-white">Success</h2>
            <div className="bg-white/5 border border-white/10 backdrop-blur-2xl p-6 rounded-2xl max-w-sm mb-12">
              <p className="text-[11px] uppercase font-bold tracking-[0.3em] text-cyan-400 mb-2 italic text-white">Report Logged Successfully</p>
      ...
      <footer className="mt-auto p-10 border-t border-white/5 text-[9px] font-bold tracking-[0.5em] text-white/20 flex justify-between items-center uppercase">
        <span>EST 2026</span>
