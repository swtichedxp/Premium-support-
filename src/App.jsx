          ...
          <div className="animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-9">
              ...
              <div className="flex flex-col gap-3">
                ...
                <textarea name="message" rows="5" placeholder="Detail the situation..." required className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 outline-none focus:border-cyan-500 focus:bg-white/10 transition-all placeholder:text-white/10
